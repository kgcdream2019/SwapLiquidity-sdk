...
export const WETH = {
  ...
  [ChainId.GORLI]: new Token(ChainId.GORLI, '0xB4FBF271143F4FBf7B91A5ded31805e42b2208d6', 18, 'WETH', 'Wrapped Ether'),
  ...
  [ChainId.HECO_TESTNET]: new Token(ChainId.HECO_TESTNET, '0xA3402dc2616D57F2cbCE2F6e0Aeb7e3F0953d8dd', 18, 'WHT', 'Wrapped Ether'),
}
